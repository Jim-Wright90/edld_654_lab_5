...
grd <- grid_regular(cost_complexity(), min_n(), levels = c(10, 5)) # is that meant by "Use grid = 10 to choose 10 grid points automatically"? 
grd
...
bag_tune <- tune_grid(bag_model_tune,
                      ...
                      data_cv,
                      grid = tree_grid,
                      metrics = metrics_eval, # use the same 3 metrics as in question 2
